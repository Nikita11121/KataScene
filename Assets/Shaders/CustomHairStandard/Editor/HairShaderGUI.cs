...
using System;
using UnityEngine;
using BlendMode = HairShaderUtility.BlendMode;

namespace UnityEditor
{
    internal class HairShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent specularShiftTexture = EditorGUIUtility.TrTextContent("Specular shift texture", "");
            
            public static GUIContent specularShift1 = EditorGUIUtility.TrTextContent("Specular shift #1", "");
            public static GUIContent specularColor1 = EditorGUIUtility.TrTextContent("Specular color #1", "");
            public static GUIContent specularExponent1 = EditorGUIUtility.TrTextContent("Specular exponent #1", "");
            
            public static GUIContent specularShift2 = EditorGUIUtility.TrTextContent("Specular shift #2", "");
            public static GUIContent specularColor2 = EditorGUIUtility.TrTextContent("Specular color #2", "");
            public static GUIContent specularExponent2 = EditorGUIUtility.TrTextContent("Specular exponent #2", "");
            public static GUIContent wrapLightingStrength = EditorGUIUtility.TrTextContent("Wrap Lighting Strength", "");
            ...
            public static string hairAreaText = "Hair Properties";
        ...
        MaterialProperty specularShiftTexture = null;
        MaterialProperty specularShift1 = null;
        MaterialProperty specularColor1 = null;
        MaterialProperty specularExponent1 = null;

        MaterialProperty specularShift2 = null;
        MaterialProperty specularColor2 = null;
        MaterialProperty specularExponent2 = null;

        MaterialProperty wrapLightingStrength;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            specularShiftTexture = FindProperty("_SpecularShiftTex", props);            
            
            specularShift1 = FindProperty("_SpecularShift1", props);            
            specularColor1 = FindProperty("_SpecularColor1", props);            
            specularExponent1 = FindProperty("_SpecularExponent1", props);            

            specularShift2 = FindProperty("_SpecularShift2", props);            
            specularColor2 = FindProperty("_SpecularColor2", props);
            specularExponent2 = FindProperty("_SpecularExponent2", props);
            
            wrapLightingStrength = FindProperty("_WrapLightingStrength", props);
